...
class SupervisorAgent:
    ...
    def run(self, state: VideoGenerationState) -> dict[str, Any]:
        """
        ...
        raw_input_type = state.get("input_type", "")
        input_type = raw_input_type.value if hasattr(raw_input_type, "value") else (raw_input_type or "")
        ...
        if input_type in TEXT_INPUT_TYPES:
            ...
            input_file_path = state.get("input_file_path") or ""
            input_file_url = state.get("input_file_url") or ""
